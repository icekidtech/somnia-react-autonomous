...
describe('Subscription Validators', () => {
  ...
  describe('Subscription ID Generation', () => {
    it('should generate consistent IDs', () => {
      const id1 = generateSubscriptionId('Transfer(address,address,uint256)', '0x1234567890123456789012345678901234567890');
      const id2 = generateSubscriptionId('Transfer(address,address,uint256)', '0x1234567890123456789012345678901234567890');
      expect(id1).toBe(id2);
    });

    it('should generate different IDs for different inputs', () => {
      const id1 = generateSubscriptionId('Transfer(address,address,uint256)', '0x1234567890123456789012345678901234567890');
      const id2 = generateSubscriptionId('Approval(address,address,uint256)', '0x1234567890123456789012345678901234567890');
...
describe('Subscription Builder', () => {
  ...
  describe('Factory Functions', () => {
    ...
    it('should create AutoCompound subscription', () => {
      const sub = createAutoCompoundSubscription(
        '0x1234567890123456789012345678901234567890',
    ...
    it('should create CronScheduler subscription', () => {
      const sub = createCronSchedulerSubscription(
        '0x1234567890123456789012345678901234567890',
        { intervalBlocks: 100 }
      );
